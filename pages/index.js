...
export default function Home({ data }) {
  ...
  return (
    <div className="container min-h-screen mx-auto">
      ...
      <main className="mt-6">
        <section className="flex items-center m-6 lg:m-0">
          <div
            className={`flex w-full lg:w-2/5 items-center py-4 px-2 rounded-lg ${
              darkMode == false
          ...
          <div
            className={`w-full ml-auto lg:w-[20%] py-4 px-2 rounded-lg ${
              darkMode == false
                ? "bg-[#2A3642] text-white"
                : "bg-gray-200 text-gray-900"
            }`}
